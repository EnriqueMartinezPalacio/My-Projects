...
def rotate_and_save_images(input_folder, output_folder):
    ...
    for folder_name in os.listdir(input_folder):
        ...
        if os.path.isdir(folder_path):
            ...
            for img in glob.glob(os.path.join(folder_path, "*.png")):
...
if __name__ == "__main__":
    input_folder = "C:/Users/enri-/Desktop/10mo_Semestre/Vision_Artificial/Dientes_3/images"
    output_folder = "C:/Users/enri-/Desktop/10mo_Semestre/Vision_Artificial/Dientes_3/Grupos/Rotated"
