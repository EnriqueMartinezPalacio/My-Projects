...
workbook = xlsxwriter.Workbook('dataTodo.xlsx')
...
pathLetterImages = 'C:/Users/enri-/Desktop/10mo_Semestre/Vision_Artificial/Final/ROI/Rotated/'

# vectorLetters = ['CAD','CAI','CD','CI','LD','LI']
# vectorLettersCount = [ 0, 0,0,0,0,0]

vectorLetters = ['Cebolla','Tomate','Limon','Papa']
vectorLettersCount = [ 0, 0,0,0]

for indice, i in enumerate(vectorLetters):
    pathLett = pathLetterImages + i
    pathImages = glob.glob(pathLett + '/*.jpg')
