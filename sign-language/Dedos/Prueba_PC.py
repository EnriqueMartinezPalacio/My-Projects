...
model_activacion = YOLO("Models/Activacion.pt")
model_acciones = YOLO("Models/Acciones.pt")
model_lugar = YOLO("Models/Lugares.pt")
model_tiempo = YOLO("Models/Tiempo.pt")
...
detection_buffer_lugar = deque(maxlen=15)       # Buffer para lugares
